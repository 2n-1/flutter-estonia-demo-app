...
@GenerateMocks([], customMocks: [
  ...
  MockSpec<GiphyService>(onMissingStub: OnMissingStub.returnDefault),
// @stacked-mock-spec
])
...
MockGiphyService getAndRegisterGiphyService() {
  _removeRegistrationIfExists<GiphyService>();
  final service = MockGiphyService();
  locator.registerSingleton<GiphyService>(service);
  return service;
}
// @stacked-mock-create
